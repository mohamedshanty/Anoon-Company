...
export default function ProgramsServer({ t }) {
    const cards = [
        {
            ...
            title: (
                <>
                    ...
                    <span className="text-brand-green">{t.cards[0].title_highlight1}</span>{" "}
                    {t.cards[0].title_middle}{" "}
                    <span className="text-brand-green">{t.cards[0].title_highlight2}</span>
                </>
            ),
        ...
        },
        {
            ...
            title: (
                <>
                    ...
                    <span className="text-brand-orange">{t.cards[1].title_highlight2}</span>
                </>
            ),
    ...
    return (
        <section id="programs" className="py-16 md:py-20 lg:py-24 relative overflow-hidden">
