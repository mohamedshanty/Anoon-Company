...
export default function FAQServer({ t, isRTL }) {
    ...
    return (
        <section id="faq" className="relative py-16 md:py-20 lg:py-24 overflow-hidden">
            ...
            <div className="main-container">
                <div className="max-w-4xl mx-auto">
                    <Reveal type="slide-up" duration={0.6}>
                        <div className={`text-center mb-12 md:mb-16 lg:mb-20 ${isRTL ? "rtl" : ""}`}>
