...
const members = [
    ...
    },
    {
        ...
        role: { ar: "مدير العمليات والتخطيط الاستراتيجي", en: "Operations & Strategic Planning Manager" },
            ...
            <div className="main-container relative z-10">
                <Reveal type="slide-up">
                    <SectionHeader
                        ...
                        subtitle={{
                            highlightedWords: [
                                { text: t.subtitle_word1 || (currentLocale === 'ar' ? "عندما" : "When"), color: "text-brand-sky" },
                                { text: t.subtitle_word2 || (currentLocale === 'ar' ? "سقط" : "Everything"), color: "text-brand-orange" },
                                { text: t.subtitle_word3 || (currentLocale === 'ar' ? "كل شيء،" : "Fell,"), color: "text-brand-sky" },
                                { text: t.subtitle_word4 || (currentLocale === 'ar' ? "نحن" : "We"), color: "text-brand-orange" },
                                { text: t.subtitle_word5 || (currentLocale === 'ar' ? "نهضنا" : "Stood"), color: "text-brand-sky" },
                                { text: t.subtitle_word6 || (currentLocale === 'ar' ? "من جديد." : "Up."), color: "text-brand-orange" },
                            ],
                        }}
                        maxWidth="4xl"
                        align="center"
