                    ...
                    <div className="space-y-8">
                        ...
                        <form className="space-y-6">
                            ...
                            <input
                                ...
                                className="w-full p-4 rounded-md bg-transparent border border-gray-300 placeholder-gray-400 outline-none"
                            />
                            <select className="w-full p-4 rounded-md bg-transparent border border-gray-300 outline-none text-gray-400">
                                <option value="" disabled selected>
                                    How did you find us?
                                </option>
                                <option value="google" className="text-brand-blue">Google</option>
                                <option value="friend" className="text-brand-blue">Friend</option>
                                <option value="social" className="text-brand-blue">Social Media</option>
                            </select>
