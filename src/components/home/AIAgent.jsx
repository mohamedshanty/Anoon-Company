...
export default function AIAgent() {
  ...
  const features = t("ai_agent.features", { returnObjects: true }) || [];
          ...
          >
            <div className="space-y-3 md:space-y-4">
              <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-semibold leading-[1.1] tracking-tight">
                <span className="text-brand-orange">{t("ai_agent.title_main")}</span>{" "}
                <span className="text-brand-sky opacity-80">{t("ai_agent.title_sub")}</span>
              </h2>
              <div className="space-y-1 md:space-y-2">
                <h3 className="text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl font-light leading-tight tracking-[0.05em] text-white/90">
                  <span className="text-brand-orange/80">{t("ai_agent.intelligent")}</span>{" "}
                  <span className="text-brand-sky/60">{t("ai_agent.software")}</span>
                </h3>
                <h3 className="text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl font-light leading-tight tracking-[0.05em] text-white/90">
                  <span className="text-brand-sky/60">{t("ai_agent.for_better")}</span>{" "}
